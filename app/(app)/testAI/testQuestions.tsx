    ...
    <View style={styles.wrapper}>
        <View style={styles.header}>
            ...
            {questions.map((_, index) => (
                <TouchableOpacity
                    key={index}
                    style={[styles.points, index === step && styles.current]}
        ...
        <View style={styles.content}>
            <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
                <Text style={styles.question}>{`${step + 1}. ${current.text}`}</Text>
        ...
        <View style={styles.footer}>
            <CustomButton showText = {step < questions.length - 1 ? 'Продолжить' : 'Завершить'} onPress={handleNext} />
        </View>
    </View>
  );
};
